...
{
 "use strict";
 var WebSharper,Obj,Html,Client,Pagelet,Text,Attribute,Element,DeprecatedTagBuilder,TagBuilder,DeprecatedAttributeBuilder,AttributeBuilder,Operators,Implementation,JQueryHtmlProvider,Default,Tags,Attr,SC$1,Events,JQueryEventSupport,EventsPervasives,SC$2,IntelliFactory,Runtime,Math,Enumerator;
